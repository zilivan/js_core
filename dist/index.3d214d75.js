...
inputBox.onkeyup = (e)=>{
    ...
    let emptyArray1;
    if (userData.length >= 3) debounceInputBox(userData);
    else wrapper.classList.remove("activ");
};
...
function showLists(list) {
    let listData;
    if (!list.length) listData = `<li>${inputBox.value}</li>`;
    else listData = list.join('');
    suggBox.innerHTML = listData;
}

},{"./select/style.scss":"044sU"}],"044sU":[function() {},{}]},["dIizP","bB7Pu"], "bB7Pu", "parcelRequire94c2")
